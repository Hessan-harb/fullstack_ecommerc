  ...
  return (
    <>
        ...
        <nav className="flex justify-between items-center py-4 ">
          <div className="hidden md:flex flex justify-between items-center py-4">
                ...
                <div className="container m-3">
                  <div className="flex">
                    ...
                    <div className="text-gray-600 cursor-pointer" onClick={toggleCart}>
                      {/* <i className="fa-sharp fa-solid fa-cart-shopping"><span>{cart.length}</span></i> */}
                        <span className="relative">
                  ...
                  <Transition.Root show={showCart} as={Fragment}>
                    <Dialog as="div" className="fixed inset-0 overflow-y-auto" onClose={setShowCart}>
